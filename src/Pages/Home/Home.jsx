      ...
      <div className="websiteIntro">
        <div className="welcome">
          <div className="welcomeContent">
            ...
            <h4>
              Unlock the joy of learning web development through an exciting,
              game-based approach with Smart Learning! Whether you're a beginner
              eager to dive into the world of HTML, CSS, and JavaScript, or
              someone looking to refresh your skills in a fun way, you've come
              to the right place.
            </h4>
          </div>
          <div className="welcomeImage">
