  ...
  return (
    <div className="flexIntro">
      ...
      <div className="flexIntroHeader">
        ...
        <h3>
          &#8594; Vertically (or) Horizontally centering a block of content
          inside its parent .
        </h3>
        <h3>
          &#8594; Making all the children of a container take up an equal amount
          of the available width/height .
        </h3>
        <div className="buttonContainer">
          <Link to="/Smart-Learning/Css/Flex/Flex1">
            <button id="flexStart">START GAME</button>
          </Link>
        </div>
      </div>
      <div className="exampleFlex">
        <div className="exampleFlexHeading">{/* <h2> Example :</h2> */}</div>
        <h2>div</h2>
